      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl h-[calc(100vh-1rem)] flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-4 grid grid-cols-3 gap-4 overflow-hidden">
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 border-2 border-cyan-300 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-cyan-800">₦{summary.openingBalance.toLocaleString('en-NG', { minimumFractionDigits: 2 })}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-green-800">₦{summary.totalSales.toLocaleString('en-NG', { minimumFractionDigits: 2 })}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-purple-800">₦{summary.expectedClosingBalance.toLocaleString('en-NG', { minimumFractionDigits: 2 })}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-300 rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-orange-800">{till?.transactionCount || 0}</p>
            </div>
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex gap-4 flex-shrink-0">
          <button
            onClick={onClose}
            disabled={loading}
            className="flex-1 px-6 py-4 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold rounded-xl transition-all active:scale-[0.98] disabled:opacity-50"
          >
            Cancel
          </button>
          <button
